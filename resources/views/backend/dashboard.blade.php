...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@400;500;600;700;800&display=swap"
        rel="stylesheet" />
    <!-- Favicon -->
    <link rel="shortcut icon" href="{{ asset('public/images/logos/favicon.png') }}" type="image/x-icon">
    ...
    <div class="flex h-screen bg-gray-800 " :class="{ 'overflow-hidden': isSideMenuOpen }">
                ...
                <div class="text-white">
                    <div class="flex p-2  bg-gray-800">
                        <div class="flex py-3 px-2 items-center">
                            {{-- <p class="text-2xl text-green-500 font-semibold">Probe Health</p class="ml-2 font-semibold italic">
                            </p> --}}
                        </div>
                    </div>
                            ...
                            <li class="relative px-2 py-1" x-data="{ Open : false  }">
                                <div class="inline-flex items-center justify-between w-full text-base font-semibold transition-colors duration-150 text-gray-500  hover:text-yellow-400 cursor-pointer"
                                    ...
                                    <span
                                        ...
                                        <span class="ml-4">Franchise</span>
                                    </span>
                                        ...
                                        <li class="px-2 py-1 text-white transition-colors duration-150">
                                            <div class="px-1 hover:text-gray-800 hover:bg-gray-100 rounded-md">
                                                <div class="flex items-center">
                                                    ...
                                                    <a href="{{ route('franchise.list') }}"
                                                        class="w-full ml-2  text-sm font-semibold text-white hover:text-gray-800">List</a>
                                                </div>
                                            </div>
                                        </li>
                                    </ul>
        ...
        <div class="flex flex-col flex-1 w-full overflow-y-auto">
            <header class="z-40 py-4  bg-gray-800   ">
                <div class="flex items-center justify-between h-8 px-6 mx-auto bg-gray-800">
                    <!-- Mobile hamburger -->
